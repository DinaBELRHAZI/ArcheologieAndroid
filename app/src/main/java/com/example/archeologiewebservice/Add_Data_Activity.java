...
public class Add_Data_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //            id des champs dans activity_add__data.xml
    ...
    private void insertData() throws JSONException {
        ...
        if(lambertX.isEmpty()){
            ...
            //            Lien de la méthode add du web service
            StringRequest request = new StringRequest(Request.Method.POST, "http://10.0.2.2:8086/JerseyArcheo/webresources/sites/add",
